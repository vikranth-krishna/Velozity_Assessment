...
import 'package:velozity_assesment/arm.dart';
...
class FootS extends StatefulWidget {
  Device device;
  final int id;
  FootS({Key? key, required this.device, required this.id}) : super(key: key);

  @override
  State<FootS> createState() => _FootSState();
}

class _FootSState extends State<FootS>with SingleTickerProviderStateMixin {
  double footval = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Foot Strength'),
      ),
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () async{
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ArmS(device: widget.device, id: id,),
                    ));
              },
            ...
            SfCartesianChart(
                ...
                title: ChartTitle(text: 'Foot Strength Analysis'),
