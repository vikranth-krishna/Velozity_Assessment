...
import 'package:velozity_assesment/leg.dart';
...
class ArmS extends StatefulWidget {
  ...
  ArmS({Key? key, required this.device, required this.id}) : super(key: key);

  @override
  State<ArmS> createState() => _ArmSState();
}

class _ArmSState extends State<ArmS> with SingleTickerProviderStateMixin {
  double armval = 0;
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => LS(device: widget.device, id: id,),
                    ));
              },
            ...
            SfCartesianChart(
                ...
                title: ChartTitle(text: 'Arm Strength Analysis'),
