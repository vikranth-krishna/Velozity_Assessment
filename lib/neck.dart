...
import 'package:velozity_assesment/back.dart';
...
class NS extends StatefulWidget {
  Device device;
  final int id;
  NS({Key? key,  required this.device, required this.id}) : super(key: key);

  @override
  State<NS> createState() => _NSState();
}

class _NSState extends State<NS>  with SingleTickerProviderStateMixin{
  double nsval = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Neck Strength'),
      ),
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () async{
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => BS(device: widget.device, id: id,),
                    ));
              },
            ...
            SfCartesianChart(
                ...
                title: ChartTitle(text: 'Neck Strength Analysis'),
