...
import 'package:velozity_assesment/foot.dart';
...
class FS extends StatefulWidget {
  ...
  FS({Key? key, required this.device, required this.id}) : super(key: key);

  @override
  State<FS> createState() => _FSState();
}

class _FSState extends State<FS> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Finger Strength'),
      ),
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FootS(device: widget.device, id: id,),
                    ));
              },
            ...
            SfCartesianChart(
                ...
                title: ChartTitle(text: 'Finger Strength Analysis'),
