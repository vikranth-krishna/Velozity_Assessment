...
import 'package:velozity_assesment/finger.dart';
...
class HgS extends StatefulWidget {
  Device device;
  final int id;

  HgS({Key? key, required this.device, required this.id}) : super(key: key);

  @override
  State<HgS> createState() => _HgSState();
}

class _HgSState extends State<HgS> with SingleTickerProviderStateMixin {
  double hgvalue = 0;
  Timer? timer;
  ...
  _write() async {
    ...
    widget.device.writeData("6e400001-b5a3-f393-e0a9-e50e24dcca9e",
        "6e400002-b5a3-f393-e0a9-e50e24dcca9e", true, data);
    print("write done");
  }
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                print(data12);
                print(hgvalue.toString());
                var _p = patient();
                String h = hgvalue.toString();
                _p.id = id;
                _p.patientid = p_id;
                _p.patientname = name;
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FS(device: widget.device, id: id,),
                    ));
              },
            ...
            //     title: ChartTitle(text: 'Hand grip Data'),
            ...
            //         markerSettings: const TrackballMarkerSettings(markerVisibility: TrackballVisibilityMode.visible,color: Colors.black),
            //
            ...
            //
            //     series: <ChartSeries<_OpKgs, String>>[
            //       SplineSeries<_OpKgs, String>(
            //           dataSource: data,
            //           xValueMapper: (_OpKgs x, _) => x.year,
            //           yValueMapper: (_OpKgs y, _) => y.weight,
            //           name: 'Data',
            ...
            SfCartesianChart(
                ...
                title: ChartTitle(text: 'HandGrip Analysis'),
                primaryXAxis: CategoryAxis(
