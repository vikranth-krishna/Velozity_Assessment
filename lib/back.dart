...
import 'package:velozity_assesment/results.dart';
...
class BS extends StatefulWidget {
  ...
  BS({Key? key, required this.device, required this.id}) : super(key: key);

  @override
  State<BS> createState() => _BSState();
}

class _BSState extends State<BS> with SingleTickerProviderStateMixin{
  double bsval = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Back Strength'),
      ),
        ...
        child: Column(
          children: [
            ...
            SfCartesianChart(
                ...
                title: ChartTitle(text: 'Back Strength Analysis'),
